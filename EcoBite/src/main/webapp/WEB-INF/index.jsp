...
<body>
	...
	<div class="container">
		<header class="header">
			...
			<a href="/joinus" class="btn">Regístrate</a> <a onclick="openNav()"
				class="menu" href="#">Menú</a>
			<div class="overlay" id="mobile-menu">
				<a href="" onclick="closeNav()" class="close">&times;</a>
				<div class="overlay-content">
					<a href="/">Home</a> <a href="/dashboard">Nosotros</a> <a
						href="/informacion">Información</a> <a href="/joinus" class="btn">Regístrate</a>
		...
		<footer>
			<div class="divcontact">
				<div class="logoimagen">
					<img src="img/ecobite-logo.png" alt="logo ecobite" width="40px"
						height="40px"><span>EcoBite</span>
				</div>
				<p>
